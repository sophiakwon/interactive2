$(document).ready(function(){
   ...
   $('.curtains').curtain();
    ...
    scrollorama.animate('.exhibitiontag',{
      delay:14230, duration:993, property:'bottom', start:0, end:993
    });

     scrollorama.animate('.bullet',{
      delay:13030, duration:2093, property:'zoom', start:0.04, end:1.5
    });

     scrollorama.animate('.varoom',{
      delay:13130, duration:93, property:'zoom', start:0, end:1
    });

     scrollorama.animate('.varoom',{
      delay:13180, duration:93, property:'opacity', start:1, end:0
    });
